        ...
        const snapshot = await firestore()
          ...
          for (const [, doc] of snapshot.docs.entries()) {
            ...
            const pageData: PageData = {
              ...
              imageUrl: await getImageUrl(Number(data.imageUrl)),
              models: data.models || [],
            };
    ...
    <View style={styles.container}>
      ...
      <ScrollView contentContainerStyle={styles.contentContainer} ref={scrollViewRef}>
        {pageDataList.map((pageData, index) => (
          <ScrollView key={index} scrollEnabled={false}>
          ...
          >
              ...
              <View style={{...styles.overlay, top : model.isPos ? model.position?.[0] : styles.overlay.top, left : model.isPos ? model.position?.[1] : styles.overlay.left}} key={id} pointerEvents="none">
